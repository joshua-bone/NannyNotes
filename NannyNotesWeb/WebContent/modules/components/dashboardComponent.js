            ...
            <ul class="nav" id="menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-stacked collapse left-submenu" id="item1">
                        <li><a href="google.com">Daily</a></li>
                        <li><a href="gmail.com">Weekly</a></li>
		 				<li><a href="gmail.com">Monthly</a></li>
                    </ul>
                </li>
		 <li><a href="#"><i class="fa fa-paperclip"></i> <span class="collapse in hidden-xs">Notes</span></a></li>
            </ul>
        </div>
        <!-- /sidebar -->
